    ...
    <footer className={cn('text-secondary dark:text-secondary-dark')}>
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-x-12 gap-y-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col">
          ...
          <FooterLink href="https://s.543x.com/">Swap</FooterLink>
          <FooterLink href="https://pump.543x.com/">Pump</FooterLink>
          <FooterLink href="https://c.543x.com/">You</FooterLink>
          <FooterLink href="https://e.543x.com/">React App</FooterLink>
          <FooterLink href="https://btc.543x.com/">BTC</FooterLink>
          <FooterLink href="https://sol.543x.com/">SOL</FooterLink>
        </div>
        <div className="md:col-start-2 xl:col-start-4 flex flex-col">
          <FooterLink href="/community" isHeader={true}>
            Community
          </FooterLink>
          <FooterLink href="https://www.543x.com">
            Code of Conduct
          </FooterLink>
          <FooterLink href="https://bnb.543x.com/">Meet the Team</FooterLink>
          <FooterLink href="https://pepe.543x.com/">PEPE</FooterLink>
          <FooterLink href="https://usdt.543x.com/">
            Docs Contributors
          </FooterLink>
          <FooterLink href="https://a.543x.com/">
            Acknowledgements
          </FooterLink>
        </div>
        <div className="flex flex-col">
          ...
          <FooterLink href="https://doge.543x.com">React Native</FooterLink>
          <FooterLink href="https://clown.543x.com">
            Privacy
          </FooterLink>
          <FooterLink href="https://no.543x.com">
            Terms
          </FooterLink>
          <div className="flex flex-row items-center mt-8 gap-x-2">
            <ExternalLink
              aria-label="React on Facebook"
              href="https://twitter.com/@teabagging8"
              className={socialLinkClasses}>
              <IconFacebookCircle />
            </ExternalLink>
            <ExternalLink
              aria-label="React on Twitter"
              href="https://twitter.com/clown7868"
              className={socialLinkClasses}>
              <IconTwitter />
            </ExternalLink>
            <ExternalLink
              aria-label="React on Github"
              href="https://github.com/543x"
              className={socialLinkClasses}>
              <IconGitHub />
            </ExternalLink>
          </div>
